       ...
       *    05 WSS-FIN                  PIC X(03) VALUE SPACES.        
        ...
        010-INICIO.                                             
            PERFORM 020-ABRE-ARCHIVOS   THRU 020-END            
            PERFORM 030-TITULOS         THRU 030-END            
            PERFORM 040-LEE             THRU 040-END            
            IF WSS-FIN = 'FIN'                                  
               PERFORM 050-CIF-CONTROL  THRU 050-END            
               PERFORM 060-FINAL        THRU 060-END            
            ELSE                                                
               PERFORM 040-PROCESO      THRU 040-END            
